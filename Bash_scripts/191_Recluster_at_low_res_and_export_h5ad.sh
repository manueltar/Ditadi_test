...
### Export_RNA_corrected_unnormalized

type=$(echo "Export_RNA_corrected_unnormalized")
outfile_Export_RNA_corrected_unnormalized=$(echo "$Log_files""outfile_5_5_""$type"".log")
touch $outfile_Export_RNA_corrected_unnormalized
echo -n "" > $outfile_Export_RNA_corrected_unnormalized
name_Export_RNA_corrected_unnormalized=$(echo "$type""_job")


Rscript_Export_RNA_corrected_unnormalized=$(echo "$Rscripts_path""513_Export_RNA_modality_for_Python_h5ad_converdion.R")
...
matrix_file=$(echo "$output_dir""final_rna_corrected_unormalized_matrix.rds")
