...
Rscript_RPCA_and_recluster=$(echo "$Rscripts_path""495_rpca_integration_and_clustering_v2.R")
filt_clustered_QCed_reclustered=$(echo "$output_dir""merged_unprocessed_db_filt_clustered_QCed_reclustered.rds")
